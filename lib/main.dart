...
class BitTorrentAPI {
  ...
  final API_TORRENT_TOGGLE_SEQUENTIAL_DOWNLOAD= '/torrents/toggleSequentialDownload' ; 
  final API_TORRENT_TOGGLE_FIRST_LAST_PRIO= '/torrents/toggleFirstLastPiecePrio' ; 
